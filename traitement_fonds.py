...
# ─── SIDEBAR ────────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown('<div style="font-family:JetBrains Mono,monospace;font-size:1rem;font-weight:700;color:#39ff14;letter-spacing:2px;padding:0.5rem 0 0.2rem">👽 GEODESIC</div><div style="font-size:0.65rem;color:#4a8a4a;letter-spacing:1.5px;margin-bottom:0.5rem;font-family:JetBrains Mono,monospace">NEW SPACE FUND</div>', unsafe_allow_html=True)
    st.markdown("---")
...
<div class="main-header">
    <div class="header-badge">👽 NEW SPACE FUND</div>
    <h1>GEODESIC — <span>Pipeline Dashboard</span></h1>
...
body { font-family: 'Space Grotesk', sans-serif; font-size: 0.79rem; background: white; }
    ...
    st.download_button(
        ...
        data=output,
        file_name=f"pipeline_geodesic_{today.strftime('%Y%m%d')}.xlsx",
